            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div>
                        <div style="padding: 7px 16px; margin: 15px 8px; line-height: 25px; text-align: center;">
                            <img src="/uploads/photos/{{ $user -> photo}}" alt="avatar.{{$user->name}}" width="30%" style="margin: auto; margin-bottom: 15px; border: 1px solid #fff; border-radius: 50%;">
                            <form action="{{ route('perfil', $user -> id)}}" method="post">
                                <label for="">Nombre</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="name" value="{{$user -> name}}"><br><br>
                                <label for="" style="text-align: left;">Fecha de nacimiento</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="date_of_birth" value="{{$user -> date_of_birth}}"><br><br>
                                <label for="">Carrera</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="career" value="{{$user -> career}}"><br><br>
                                <label for="">Correo</label>
                                <input readonly="true" style="color: #000; width: 300px;" type="text" name="email" value="{{$user -> email}}"><br><br>
    ...
    <nav id="navbar">
        <ul>
            ...
            <li class="w-full h-full py-4 px-2 border-b border-light-border">
                ...
                <x-nav-link class="text-white" :href="route('swaps')"
