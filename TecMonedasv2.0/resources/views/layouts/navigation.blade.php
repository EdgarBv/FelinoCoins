        ...
        <div class="flex justify-between h-16">
            ...
            <div class="sm:ml-6 flex items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center text-sm font-medium text-white hover:text-gray-400 hover:border-gray-400 focus:outline-none focus:text-gray-400 focus:border-gray-400 transition duration-150 ease-in-out">
