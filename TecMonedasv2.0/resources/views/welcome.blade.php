    ...
    <div style="background-color: rgb(0 12 66);"
        ...
        <div class="max-w-6xl sm:px-6 lg:px-8">
            <div id="name" style="color: white; text-align: center; margin-top: 8%;">
                <h1>BIENVENIDO A<span>TECMONEDAS</span></h1>
            ...
            <div class="desc" style="color: #fff; margin: 40px; text-align: center; font-size: 1.3rem;">
                <p>Participa en los eventos que organiza el Tecnológico de Motul y cumple con tus actividades para poder conseguir TecMonedas totalmente gratis. Podrás usarlas en los canjes de este sitio.</p>
            </div>
        </div>
