...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <x-app-layout>
            ...
            <h1 style="font-size: 2rem; text-align: center; padding: 30px; background-color: rgb(0 12 66); color: #fff;">
                Canjear TecMonedas
            </h1>
            <div style="font-size: 1.2rem; text-align: center; padding: 30px; background-color: rgb(0 12 66); color: rgb(212,175,55);;">
                <p><b style="border: 1px solid rgb(212,175,55);; padding: 5px 7px;">Mis TecMonedas: {{ Auth::user()->coins }} tm</b></p>
            </div>
                        ...
                        <div style="padding: 7px 16px; margin: 15px 8px; line-height: 25px; text-align: center;">
                            ...
                            <form action="{{route('admin.store')}}" method="POST">
                                ...
                                <input hidden="true" style="color: #000;" type="text" name="expiracion" placeholder="Expiración" autocomplete="off" value="
                                    ...
                                    ?>
                                ">
                                <input hidden="true" style="color: #000;" type="text" name="estado" placeholder="Estado" autocomplete="off" value="activo">
